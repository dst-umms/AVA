...
rule target:
  input:
    "/usr/local/bin/analysis/{proj_name}/{proj_name}.hg19_multianno.txt.intervar".format(proj_name = config["proj_name"])
...
rule run_intervar:
  ...
  output:
    "/usr/local/bin/analysis/{proj_name}/{proj_name}.hg19_multianno.txt.intervar"
  params:
