...
if __name__ == "__main__":
  ...
  results = results[["Chrom", "Position", "Reference", "Alternate", "Protein Consequence", 
    "Transcript Consequence", "Annotation", "Allele Frequency", "RSID", "Gene", "Comments"]] 
  results.columns = ["Chrom", "Start", "Ref", "Alt", "p.gnomad", "c.gnomad", "func.gnomad", "AF.gnomad", "rs.gnomad", "Gene", "Comments"]
